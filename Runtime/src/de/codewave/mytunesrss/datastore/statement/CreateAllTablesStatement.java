...
public class CreateAllTablesStatement implements DataStoreStatement {
    public void execute(Connection connection) throws SQLException {
        ...
        connection.createStatement().execute("CREATE TABLE link_track_playlist ( index INTEGER, track_id VARCHAR, playlist_id VARCHAR )");
        ...
        connection.createStatement().execute("CREATE TABLE album ( name VARCHAR, first VARCHAR, track_count INTEGER, artist_count INTEGER, artist VARCHAR )");
        connection.createStatement().execute("CREATE TABLE artist ( name VARCHAR, first VARCHAR, track_count INTEGER, album_count INTEGER )");
