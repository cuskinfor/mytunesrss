...
public abstract class HttpExchangeUpnpStream extends UpnpStream {
    ...
    public static ThreadLocal<String> REQUEST_LOCAL_ADDRESS = new ThreadLocal<>();
    ...
    public void run() {
        ...
        try {
            ...
            REQUEST_LOCAL_ADDRESS.set(getHttpExchange().getLocalAddress().getAddress().getHostAddress());
