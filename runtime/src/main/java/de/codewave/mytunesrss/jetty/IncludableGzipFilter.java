...
public class IncludableGzipFilter extends GzipFilter
{
    ...
    public class IncludableResponseWrapper extends GzipResponseWrapper
    {
        public IncludableResponseWrapper(HttpServletRequest request, HttpServletResponse response)
        {
            ...
            setMimeTypes(IncludableGzipFilter.this._mimeTypes);
            setBufferSize(IncludableGzipFilter.this._bufferSize);
            setMinGzipSize(IncludableGzipFilter.this._minGzipSize);
        }
