...
public class IphotoAlbumListener extends AlbumListener implements PListHandlerListener {
    ...
    public IphotoAlbumListener(Thread watchdogThread, DatabaseUpdateQueue queue, LibraryListener libraryListener, Map<String, String> photoIdToPersId) throws SQLException {
