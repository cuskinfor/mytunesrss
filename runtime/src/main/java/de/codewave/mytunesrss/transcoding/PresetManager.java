...
public class PresetManager implements Runnable {
    ...
    public static final String PRESETS_URL = "http://www.mytunesrss.com/tools/transcoders.xml";
    ...
    public PresetManager() {
        myIphoneVideo = create(
                ...
                "video/MP2T",
                "ffmpeg",
                "-i - -threads 4 -f mpegts -r 25 -vcodec libx264 -s 480x272 -flags +loop -cmp +chroma -deblockalpha 0 -deblockbeta 0 -crf 24 -b 150K -bt 175K -refs 1 -coder 0 -me_range 16 -subq 5 -partitions +parti4x4+parti8x8+partp8x8 -g 250 -keyint_min 25 -level 30 -qmin 10 -qmax 51 -trellis 2 -sc_threshold 40 -i_qfactor 0.71 -acodec libmp3lame -ab 64k -ar 44100 -ac 2 -"
        );
        myMp3Audio = create(
                "MP3 Audio",
                "^.+\\.(mp4|m4a|m4b)$",
                ...
                "audio/mp3",
                "ffmpeg",
                "-i - -f mp3 -ar 44100 -ab 128k -acodec libmp3lame -"
        );
    ...
    public void run() {
        ...
        try {
            if (httpClient.executeMethod(getMethod) == 200) {
                ...
                Iterator<JXPathContext> iterator = JXPathUtils.getContextIterator(context, "transcoder-presets/v42/transcoder");
