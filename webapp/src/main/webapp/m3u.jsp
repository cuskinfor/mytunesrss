...
<c:forEach items="${tracks}" var="item">#EXTINF:${item.time * timefactor},<c:out value="${cwfn:choose(mtfn:unknown(item.originalArtist), msgUnknown, item.originalArtist)}" /> - ${item.name}
