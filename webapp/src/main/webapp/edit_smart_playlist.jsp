...
<div class="body">
    ...
    <form id="playlist" action="${servletUrl}/saveSmartPlaylist/${auth}" method="post">
        ...
        <table cellspacing="0">
            ...
            <tr <mt:flipFlop/>>
                <td><fmt:message key="smartPlaylist.smartInfo.protected" /></td>
                <td>
