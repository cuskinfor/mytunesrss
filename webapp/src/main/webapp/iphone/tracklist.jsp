...
<script type="text/javascript">
    ...
    function buildList() {
        ...
        html += "</table>";
        $jQ('#tracklist').html(html);
        $jQ('#pager1').html(createPager("<td align='center' onclick='top.loadContent(\"${appUrl}/iphone/portal.jsp\")'><input type=submit style='font-size:14px; width:64px' value='menu'></td>", currentList.length, pageSize));
        $jQ('#pager2').html(createPager("<td align='center' onclick='document.location.href=\"#top\"'><input type=submit style='font-size:14px; width:64px' value='top'></td>", currentList.length, pageSize));
    }
</script>
</head>
