...
public enum MyTunesRssCommand implements Command {
    ...
    BrowseTvShowEpisodes("browseTvShowEpisodes", BrowseTvShowCommandHandler.class),
    BrowseTvShowSeriesEpisodes("browseTvShowSeriesEpisodes", BrowseTvShowSeriesEpisodesCommandHandler.class),
    BrowseTvShowSeriesSeasonEpisodes("browseTvShowSeriesSeasonEpisodes", BrowseTvShowSeriesSeasonEpisodesCommandHandler.class),
