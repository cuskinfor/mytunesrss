    ...
    public Object addArtists(String[] artists, boolean fullAlbums) throws IllegalAccessException, SQLException {
        ...
        if (user != null && user.isCreatePlaylists()) {
            if (fullAlbums) {
                ...
                return addAlbumsFromQuery(new FindAlbumQuery(user, null, artists[0], null, -1, -1, -1, false, FindAlbumQuery.AlbumType.ALL));
            } else {
    ...
    public Object addGenres(String[] genres, boolean fullAlbums) throws IllegalAccessException, SQLException {
        ...
        if (user != null && user.isCreatePlaylists()) {
            if (fullAlbums) {
                ...
                return addAlbumsFromQuery(new FindAlbumQuery(user, null, null, genres[0], -1, -1, -1, false, FindAlbumQuery.AlbumType.ALL));
            } else {
