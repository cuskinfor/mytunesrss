...
<c:set var="backUrl" scope="request">${servletUrl}/browseAlbum/<mt:encrypt>artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}/page=${param.page}/index=${param.index}</mt:encrypt></c:set>
...
<ul class="links">
    <li>
        <a href="${servletUrl}/browseArtist/<mt:encrypt>page=${cwfn:choose(empty param.artist, param.page, '1')}</mt:encrypt>"><fmt:message key="browseArtist"/></a>
    </li>
    <c:if test="${registered}">
        <li>
            <a href="${servletUrl}/browseGenre/<mt:encrypt>page=${param.page}</mt:encrypt>"><fmt:message key="browseGenres"/></a>
        </li>
    </c:if>
...
<form id="browse" action="" method="post">
    ...
    <table class="select" cellspacing="0">
        ...
        <c:forEach items="${albums}" var="album" varStatus="loopStatus">
            <tr class="${cwfn:choose(loopStatus.index % 2 == 0, 'even', 'odd')}">
                    ...
                    <c:choose>
                        <c:when test="${album.artistCount == 1}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="${servletUrl}/browseAlbum/<mt:encrypt>artist=${cwfn:encodeUrl(mtfn:encode64(album.artist))}</mt:encrypt>?backUrl=${cwfn:encodeUrl(backUrl)}">
                ...
                <td class="tracks">
                    <a href="${servletUrl}/browseTrack/<mt:encrypt>album=${cwfn:encodeUrl(mtfn:encode64(album.name))}</mt:encrypt>?backUrl=${cwfn:encodeUrl(backUrl)}"> ${album.trackCount} </a>
                </td>
                <c:choose>
                    <c:when test="${empty sessionScope.playlist}">
                        <c:if test="${authUser.rss && config.showRss}">
                            <td class="icon">
                                <a href="${servletUrl}/createRSS/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/album=${cwfn:encodeUrl(mtfn:encode64(album.name))}</mt:encrypt>/${mtfn:virtualAlbumName(album)}.xml">
                        ...
                        <c:if test="${authUser.playlist && config.showPlaylist}">
                            <td class="icon">
                                <a href="${servletUrl}/createPlaylist/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/album=${cwfn:encodeUrl(mtfn:encode64(album.name))}</mt:encrypt>/${mtfn:virtualAlbumName(album)}.${config.playlistFileSuffix}">
                        ...
                        <c:if test="${authUser.player && config.showPlayer}">
                            <td class="icon">
                                <a href="#" onclick="openPlayer('${appUrl}/flashplayer/xspf_player.swf?autoplay=true&amp;autoload=true&amp;playlist_url=${servletUrl}/createPlaylist/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/album=${cwfn:encodeUrl(mtfn:encode64(album.name))}/type=Xspf</mt:encrypt>/${mtfn:virtualAlbumName(album)}.xspf')">
                            ...
                            <td class="icon">
                                <c:choose>
                                    <c:when test="${authUser.maximumZipEntries <= 0 || album.trackCount <= authUser.maximumZipEntries}">
                                        <a href="${servletUrl}/getZipArchive/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/album=${cwfn:encodeUrl(mtfn:encode64(album.name))}</mt:encrypt>/${mtfn:virtualAlbumName(album)}.zip">
                    ...
                    <c:otherwise>
                        <td class="icon">
                            <a href="${servletUrl}/addToPlaylist/<mt:encrypt>album=${cwfn:encodeUrl(mtfn:encode64(album.name))}</mt:encrypt>?backUrl=${cwfn:encodeUrl(backUrl)}">
        ...
        <c:if test="${(singleArtist || singleGenre) && fn:length(albums) > 1}">
            <tr class="${cwfn:choose(fn:length(albums) % 2 == 0, 'even', 'odd')}">
                ...
                <td class="tracks">
                    <a href="${servletUrl}/browseTrack/<mt:encrypt>fullAlbums=true/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>?backUrl=${cwfn:encodeUrl(backUrl)}">${allAlbumsTrackCount}</a>
                </td>
                <c:choose>
                    <c:when test="${empty sessionScope.playlist}">
                        <c:if test="${authUser.rss && config.showRss}">
                            <td class="icon">
                                <a href="${servletUrl}/createRSS/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/fullAlbums=true/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>/${mtfn:webSafeFileName(mtfn:decode64(param.artist))}.xml">
                        ...
                        <c:if test="${authUser.playlist && config.showPlaylist}">
                            <td class="icon">
                                <a href="${servletUrl}/createPlaylist/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/fullAlbums=true/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>/${mtfn:webSafeFileName(mtfn:decode64(param.artist))}.${config.playlistFileSuffix}">
                        ...
                        <c:if test="${authUser.player && config.showPlayer}">
                            <td class="icon">
                                <a href="#" onclick="openPlayer('${appUrl}/flashplayer/xspf_player.swf?autoplay=true&amp;autoload=true&amp;playlist_url=${servletUrl}/createPlaylist/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/fullAlbums=true/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}/type=Xspf</mt:encrypt>/${mtfn:webSafeFileName(mtfn:decode64(param.artist))}.xspf')">
                            ...
                            <td class="icon">
                                <c:choose>
                                    <c:when test="${authUser.maximumZipEntries <= 0 || allAlbumsTrackCount <= authUser.maximumZipEntries}">
                                        <a href="${servletUrl}/getZipArchive/<mt:encrypt>auth=${cwfn:encodeUrl(auth)}/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>/${mtfn:webSafeFileName(mtfn:decode64(param.artist))}.zip">
                    ...
                    <c:otherwise>
                        <td class="icon">
                            <a href="${servletUrl}/addToPlaylist/<mt:encrypt>fullAlbums=true/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>?backUrl=${cwfn:encodeUrl(backUrl)}">
    ...
    <c:if test="${!empty indexPager}">
        ...
        <c:set var="pagerCommand" scope="request">${servletUrl}/browseAlbum/<mt:encrypt>page=${param.page}/artist=${cwfn:encodeUrl(param.artist)}/genre=${cwfn:encodeUrl(param.genre)}</mt:encrypt>?index={index}&amp;backUrl=${cwfn:encodeUrl(param.backUrl)}</c:set>
